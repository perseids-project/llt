...
Warbler::Config.new do |config|
  ...
  # config.gems << "tzinfo"
  #config.gems += ["activerecord-jdbc-adapter","activerecord-jdbcpostgresql-adapter","celluloid","docile","hitimes"]
  #config.gems += ["jdbc-postgres","jruby-httpclient","json","timers","tins","xml_escape","bundler"]
  config.gems -= ["warbler"]
